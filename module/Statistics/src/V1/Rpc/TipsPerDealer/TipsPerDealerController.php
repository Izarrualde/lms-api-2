...
class TipsPerDealerController extends BaseControllerRpc
{
    ...
    public function tipsPerDealerAction()
    {
        ...
        $sessions = $this->sessionService->fetchTipsPerDealerBetweenDates($data);
