...
use Solcre\Lms\Entity\ScheduledNotificationEntity;
...
class ScheduledNotificationService extends BaseService
{
            ...
            if (! empty($notifications) && is_array($notifications))
            {
                foreach ($notifications as $notification)
                {
                    if ($this->lockScheduledNotificationsTable())
                    {
                        ...
                        $androidDevices = $this->getDevicesWithoutSending($notification['id'], self::PLATFORM_ID['android'], self::DEVICES_LIMIT_MAX['android']);
                        $iosDevices = $this->getDevicesWithoutSending($notification['id'], self::PLATFORM_ID['ios'], self::DEVICES_LIMIT_MAX['ios']);
    ...
    private function lockScheduledNotificationsTable()
    {
    ...
    private function UnlockScheduledNotificationsTable()
    {
