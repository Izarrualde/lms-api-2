<?php namespace Solcre\Lms\Service;

use Doctrine\ORM\EntityManager;
use Solcre\Lms\Entity\AwardEntity;
use Solcre\Lms\Entity\SessionUserEntity;
use Solcre\SolcreFramework2\Service\BaseService;
use Exception;
use Solcre\Lms\Entity\MeEntity;
...
class MeService extends BaseService
{
    ...
    public function __construct(EntityManager $entityManager, UserService $userService, PermissionService $permissionService, AwardService $awardService, SessionUserService $sessionUserService)
    {
    ...
    {
        $user = $this->userService->fetchBy(['cellphone' => $data['cellphone']]);
        if ($user instanceof UserEntity)
        {
            ...
            $permissions = $this->permissionService->getAllPermissions($user->getCellphone());
    ...
    {
        $historicalSessions = $this->sessionUserService->getHistoricalSessions($user, self::COUNT_OF_HISTORICAL_SESSIONS);
